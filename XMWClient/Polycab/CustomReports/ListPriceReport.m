...
@interface ListPriceReport () <CustomRenderDelegate, UIDocumentInteractionControllerDelegate>
{
...
@implementation ListPriceReport
...
-(void) downloadPDF:(NSInteger) rowIndex
{
    ...
    NSString* sheetUri = [rowData objectAtIndex:5];
