...
- (void)setupSwipingView {
    ...
    _colorIndicatorView = [[UIView alloc] initWithFrame:self.bounds];//change ashish added on 21 feb
    /*if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
        if([UIScreen mainScreen].bounds.size.height == 568.0){
             _colorIndicatorView = [[UIView alloc] initWithFrame:CGRectMake(0, 2, self.bounds.size.width, 36)];
        } else {
             _colorIndicatorView = [[UIView alloc] initWithFrame:CGRectMake(0, 2, self.bounds.size.width, 36)];
    ...
    _slidingView.contentMode = UIViewContentModeCenter;//change ashish
