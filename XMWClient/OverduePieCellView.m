...
{
    OverduePieCellView *view = (OverduePieCellView *)[[[NSBundle mainBundle] loadNibNamed:@"OverduePieCellView" owner:self options:nil] objectAtIndex:0];
