...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
		...
		[pickerToolBar sizeToFit];
                ...
                UIButton* cancelButton = [[UIButton alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 80.0f, 40.0f)];
                [cancelButton setTitle:@"Cancel" forState:UIControlStateNormal];
                [cancelButton addTarget:self action:@selector(cancelButtonPressed:) forControlEvents:UIControlEventTouchUpInside];
        
                UIButton* doneButton = [[UIButton alloc] initWithFrame:CGRectMake(screenRect.size.width - 80.0f, 0.0f, 80.0f , 40.0f)];
        ...
        pickerToolBar.items = @[leftButton,rightButton];
